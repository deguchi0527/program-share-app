...
# 制作背景(意図)
### エンジニアやプログラミング学習者が知識を共有するコミュニケーションアプリ。<br>画像や該当記事を貼り投稿し、互いに知識を向上させる。<br>コメントでその投稿に対して質問する事ができる。<br>また、投稿を非公開にすることで自分だけが確認できるメモ機能により、手軽に知識のアウトプット、記録を残す事ができる。

# 利用方法
- 投稿やコメント、いいねをする為に新規登録をおこなう(閲覧のみなら登録不要)。
